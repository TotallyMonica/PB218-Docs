...
# Set SFP+ ports to be native Net-MGMT
...
# Set access VLAN to be tagged on SFP+ ports
configure vlan Access add ports 25-32 tagged

# Set WAN VLAN to be tagged on SFP+ ports
# RJ45 must be opt-in
configure vlan WAN add ports 1-32 tagged

# Set Cluster Management VLAN to be tagged on SFP+ ports
# RJ45 must be opt-in
